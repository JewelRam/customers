...
const vegetarianIngredients = customers.customers.map(key => {
    
    return key.contacts.email
})
const allEmails = [].concat.apply([],vegetarianIngredients)
...
const integers = [13, 25, 6, 3, 11, 2, 18, 7, 21, 1, 29, 20, 12, 8]
    ...
    const result = integers.filter(integer => integer >= 19);
    console.log(sort) 
